...
public class dbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String tb_NhanVien = "CREATE TABLE NHANVIEN (MANV INTEGER PRIMARY KEY AUTOINCREMENT, TENDN TEXT, MATKHAU TEXT, GIOITINH TEXT, NGAYSINH TEXT, CCCD INTEGER, QUYEN INTEGER)";
